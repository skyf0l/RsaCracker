...
### Factor N when partial bits of prime p or q are known

When you know some bits (MSB or LSB) of one of the prime factors, you can use the `partial_p` attack. The attack supports up to 40 unknown bits and works with either partial p or partial q.
...
# Or with partial q
rsacracker -n <modulus> -q <q_lsb> --attack partial_p --dump
```
...
# Or with partial q
rsacracker -n <modulus> -q <q_msb> --attack partial_p --dump
```
